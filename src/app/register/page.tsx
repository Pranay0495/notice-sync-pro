  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-6 bg-grid-pattern">
      ...
      >
        ...
        <Suspense fallback={<div className="glass p-8 rounded-3xl border border-white/10 shadow-2xl flex items-center justify-center min-h-[400px]"><Loader2 className="w-8 h-8 animate-spin text-primary" /></div>}>
          <RegisterForm />
        </Suspense>
      </motion.div>
    </div>
